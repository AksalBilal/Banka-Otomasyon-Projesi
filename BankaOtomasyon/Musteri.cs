...
namespace BankaOtomasyon
{
    public class Musteri:Kisi
    {
        ...
        public void ParaYatir(int hesapno, decimal para)
        {
            ...
            foreach (Hesap h in Hesaplar)
            {
                if (h.HesapNo == hesapno)
                {
                    ...
                    else if (h.Tur == "Ticari" && h.EkHesapBakiyesi == 1000)
                    {
                        h.Bakiye += para;
                    }
                    ...
                    else if (h.Tur == "Bireysel" && h.EkHesapBakiyesi == 500)
                    {
                        h.Bakiye += para;
                    }
        ...
        public void ParaCek(int hesapno, decimal para)
        {
            ...
            foreach (Hesap h in Hesaplar)
            {
                ...
                if (h.HesapNo == hesapno)
                {
                    ...
                    else if (h.Bakiye + h.EkHesapBakiyesi  < para)
                    {
        ...
        public int HavaleKontrol = 0,k=0;
